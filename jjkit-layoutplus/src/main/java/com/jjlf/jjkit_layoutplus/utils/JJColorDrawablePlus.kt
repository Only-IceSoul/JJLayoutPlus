...
internal class JJColorDrawablePlus : Drawable() {
    ...
    fun setStrokeShadow(@FloatRange(from = 0.0 ,to = 7.0) radius: Float,color: Int, shadowPath: ((RectF,Path)-> Unit)?): JJColorDrawablePlus {
    ...
    fun setScale(x: Float,y: Float): JJColorDrawablePlus {
        mScaleX = x
        mScaleY = y
        return this
    }

    fun setShape(type:Int): JJColorDrawablePlus {
        mIsNewPath = false
    ...
    fun setStroke(width: Float, color: Int) : JJColorDrawablePlus {
        mIsStroke = true
    ...
    fun setStrokeColor(color:Int) : JJColorDrawablePlus {
        mPaintStroke.color = color
        return this
    }

    //new layer stroke plus shadow layer
    fun setStrokeAndShadowLayer(width: Float, color: Int,shadowRadius: Float,shadowOffsetX:Float,shadowOffsetY:Float,shadowColor:Int) : JJColorDrawablePlus {
        mIsStroke = true
        mPaintStroke.strokeWidth = width
        mPaintStroke.color = color
    ...
    fun setRadius(radius: Float) : JJColorDrawablePlus {
    ...
    fun setRadius(radius: FloatArray) : JJColorDrawablePlus {
        mRadius = radius
        mIsNewPath = false
        mIsPathClosure = false
        mShape = 0
    ...
    fun setRadius(topLeft: Float,topRight:Float,bottomRight:Float,bottomLeft:Float) : JJColorDrawablePlus {
    ...
    fun setFillColor(color: Int) : JJColorDrawablePlus {
        mPaint.color = color
        return this
    }

    fun setIsFillEnabled(boolean: Boolean) : JJColorDrawablePlus {
        mIsFill = boolean
        return this
    }

    fun setIsStrokeEnabled(boolean: Boolean) : JJColorDrawablePlus {
        mIsStroke = boolean
        return this
    }

    fun setIsStrokeShadowEnabled(boolean: Boolean) : JJColorDrawablePlus {
        mIsStrokeShadow = boolean
        return this
    }
    fun setPadding(padding: JJPadding): JJColorDrawablePlus {
        mPadding = padding
        return this
    }

    fun setOffset(x: Float,y: Float): JJColorDrawablePlus {
        mOffsetX = x
        mOffsetY = y
        return this
    }
    ...
    fun setPath(path:Path): JJColorDrawablePlus {
        mIsNewPath = true
        mIsPathClosure = false
        mPath = path
        mShape = 0
    ...
    fun setPath(closure:(RectF, Path)->Unit): JJColorDrawablePlus {
        mIsNewPath = true
        mIsPathClosure = true
        mSetupPath = closure
        mShape = 0
    ...
    fun diposePath(): JJColorDrawablePlus {
        mIsNewPath = false
        mIsPathClosure = false
        mPath.reset()
        mSetupPath = null
    ...
    fun diposeStrokeShadow(): JJColorDrawablePlus {
        mIsStrokeShadow = false
