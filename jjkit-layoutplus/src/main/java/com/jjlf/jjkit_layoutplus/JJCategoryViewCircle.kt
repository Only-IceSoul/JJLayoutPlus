...
class JJCategoryViewCircle : ConstraintLayout {
    ...
    private fun setupViews(context: Context,attrs: AttributeSet?){
        ...
        if(mImageView.drawable == null) mImageView.setImageResource(R.drawable.ic_category)


        val t = context.obtainStyledAttributes(attrs,R.styleable.JJCategoryViewCircle,0,0)
        val surface = t.getColor(R.styleable.JJCategoryViewCircle_colorSurface,Color.parseColor("#F62F42"))
        val onSurface = t.getColor(R.styleable.JJCategoryViewCircle_colorOnSurface,Color.parseColor("#FFFFFF"))
        t.recycle()
...
//        val onSurPre =  (color and 0x00ffffff) or (opacity << 24)
    ...
    fun setText(s:String): JJCategoryViewCircle {
        mTextView.text = s
        return this
    }

    fun setText(resId:Int): JJCategoryViewCircle {
        mTextView.setText(resId)
        return this
    }

    fun setOnImageClickListener(listener: (view: View) -> Unit): JJCategoryViewCircle{
        mImageView.setOnClickListener(listener)
        return this
    }
    fun setImageResource(resId:Int): JJCategoryViewCircle{
        mImageView.setImageResource(resId)
        return this
    }

    fun setTextSize(size:Float) : JJCategoryViewCircle{
        mTextView.textSize = size
        return this
    }
    fun setTextColor(color:Int) : JJCategoryViewCircle{
        mTextView.setTextColor(color)
        return this
    }
    fun setTypeFace(typeface: Typeface) : JJCategoryViewCircle{
        mTextView.typeface = typeface
        return this
    }

    fun setColorSurface(color: Int): JJCategoryViewCircle{
        val dr = (mImageView.background as JJColorDrawablePlus).setFillColor(color)
        dr.invalidateSelf()
        return this
    }
    fun setColorOnSurface(color: Int): JJCategoryViewCircle {
    ...
    private fun setupMarginCl(a: TypedArray, index:Int){
        ...
        when(a.getIndex(index)){
            R.styleable.jjlayoutplus_clMarginEnd ->{
                margins.right = a.getDimension(R.styleable.jjlayoutplus_clMarginEnd,0f).toInt()
            }
            R.styleable.jjlayoutplus_clMarginStart ->{
                margins.left = a.getDimension(R.styleable.jjlayoutplus_clMarginStart,0f).toInt()
            }
            R.styleable.jjlayoutplus_clMarginTop ->{
                margins.top = a.getDimension(R.styleable.jjlayoutplus_clMarginTop,0f).toInt()
            }
            R.styleable.jjlayoutplus_clMarginBottom ->{
                margins.bottom = a.getDimension(R.styleable.jjlayoutplus_clMarginBottom,0f).toInt()
            }

            R.styleable.jjlayoutplus_clMarginEndPercentScreenHeight -> {
                margins.right = JJScreen.percentHeight(a.getFloat(R.styleable.jjlayoutplus_clMarginEndPercentScreenHeight,0f))
            }
            R.styleable.jjlayoutplus_clMarginStartPercentScreenHeight -> {
                margins.left = JJScreen.percentHeight(a.getFloat(R.styleable.jjlayoutplus_clMarginStartPercentScreenHeight,0f))
            }
            R.styleable.jjlayoutplus_clMarginTopPercentScreenHeight -> {
                margins.top = JJScreen.percentHeight(a.getFloat(R.styleable.jjlayoutplus_clMarginTopPercentScreenHeight,0f))
            }
            R.styleable.jjlayoutplus_clMarginBottomPercentScreenHeight -> {
                margins.bottom = JJScreen.percentHeight(a.getFloat(R.styleable.jjlayoutplus_clMarginBottomPercentScreenHeight,0f))
            }

            R.styleable.jjlayoutplus_clMarginEndPercentScreenWidth -> {
                margins.right = JJScreen.percentWidth(a.getFloat(R.styleable.jjlayoutplus_clMarginEndPercentScreenWidth,0f))
            }
            R.styleable.jjlayoutplus_clMarginStartPercentScreenWidth -> {
                margins.left = JJScreen.percentWidth(a.getFloat(R.styleable.jjlayoutplus_clMarginStartPercentScreenWidth,0f))
            }
            R.styleable.jjlayoutplus_clMarginTopPercentScreenWidth -> {
                margins.top = JJScreen.percentWidth(a.getFloat(R.styleable.jjlayoutplus_clMarginTopPercentScreenWidth,0f))
            }
            R.styleable.jjlayoutplus_clMarginBottomPercentScreenWidth -> {
                margins.bottom = JJScreen.percentWidth(a.getFloat(R.styleable.jjlayoutplus_clMarginBottomPercentScreenWidth,0f))
            }
            R.styleable.jjlayoutplus_clMargin -> {
                margins = JJMargin.all(a.getDimension(R.styleable.jjlayoutplus_clMargin,0f).toInt())
            }
            R.styleable.jjlayoutplus_clMarginPerScHeight -> {
                margins = JJMargin.all(JJScreen.percentHeight( a.getFloat(R.styleable.jjlayoutplus_clMarginPerScHeight,0f)))
            }
            ...
            R.styleable.jjlayoutplus_clMarginStartResponsive -> {
                margins.left = responsiveSizeDimension(a, R.styleable.jjlayoutplus_clMarginStartResponsive)
            }
            R.styleable.jjlayoutplus_clMarginTopResponsive -> {
                margins.top = responsiveSizeDimension(a, R.styleable.jjlayoutplus_clMarginTopResponsive)
            }
            R.styleable.jjlayoutplus_clMarginBottomResponsive -> {
                margins.bottom = responsiveSizeDimension(a, R.styleable.jjlayoutplus_clMarginBottomResponsive)
            }

            R.styleable.jjlayoutplus_clMarginEndResPerScHeight -> {
                margins.right = responsiveSizePercentScreenHeight(a, R.styleable.jjlayoutplus_clMarginEndResPerScHeight)
            }
            R.styleable.jjlayoutplus_clMarginStartResPerScHeight -> {
                margins.left = responsiveSizePercentScreenHeight(a, R.styleable.jjlayoutplus_clMarginStartResPerScHeight)
            }
            R.styleable.jjlayoutplus_clMarginTopResPerScHeight -> {
                margins.top = responsiveSizePercentScreenHeight(a, R.styleable.jjlayoutplus_clMarginTopResPerScHeight)
            }
            R.styleable.jjlayoutplus_clMarginBottomResPerScHeight -> {
                margins.bottom = responsiveSizePercentScreenHeight(a, R.styleable.jjlayoutplus_clMarginBottomResPerScHeight)
            }

            R.styleable.jjlayoutplus_clMarginEndResPerScWidth -> {
                margins.right = responsiveSizePercentScreenWidth(a, R.styleable.jjlayoutplus_clMarginEndResPerScWidth)
            }
            R.styleable.jjlayoutplus_clMarginStartResPerScWidth -> {
                margins.left = responsiveSizePercentScreenWidth(a, R.styleable.jjlayoutplus_clMarginStartResPerScWidth)
            }
            R.styleable.jjlayoutplus_clMarginTopResPerScWidth -> {
                margins.top = responsiveSizePercentScreenWidth(a, R.styleable.jjlayoutplus_clMarginTopResPerScWidth)
            }
            R.styleable.jjlayoutplus_clMarginBottomResPerScWidth -> {
                margins.bottom = responsiveSizePercentScreenWidth(a, R.styleable.jjlayoutplus_clMarginBottomResPerScWidth)
            }
    ...
    private fun setupMarginCll(a: TypedArray, index:Int){
        ...
        when (a.getIndex(index)) {
            R.styleable.jjlayoutplus_cllMarginEnd -> {
                lsMargins.right = a.getDimension(R.styleable.jjlayoutplus_cllMarginEnd,0f).toInt()
            }
            R.styleable.jjlayoutplus_cllMarginStart -> {
                lsMargins.left = a.getDimension(R.styleable.jjlayoutplus_cllMarginStart,0f).toInt()
            }
            R.styleable.jjlayoutplus_cllMarginTop -> {
                lsMargins.top = a.getDimension(R.styleable.jjlayoutplus_cllMarginTop,0f).toInt()
            }
            R.styleable.jjlayoutplus_cllMarginBottom -> {
                lsMargins.bottom = a.getDimension(R.styleable.jjlayoutplus_cllMarginBottom,0f).toInt()
            }

            R.styleable.jjlayoutplus_cllMarginEndPercentScreenHeight -> {
                lsMargins.right = JJScreen.percentHeight(a.getFloat(R.styleable.jjlayoutplus_cllMarginEndPercentScreenHeight,0f))
            }
            R.styleable.jjlayoutplus_cllMarginStartPercentScreenHeight -> {
                lsMargins.left = JJScreen.percentHeight(a.getFloat(R.styleable.jjlayoutplus_cllMarginStartPercentScreenHeight,0f))
            }
            R.styleable.jjlayoutplus_cllMarginTopPercentScreenHeight -> {
                lsMargins.top = JJScreen.percentHeight(a.getFloat(R.styleable.jjlayoutplus_cllMarginTopPercentScreenHeight,0f))
            }
            R.styleable.jjlayoutplus_cllMarginBottomPercentScreenHeight -> {
                lsMargins.bottom = JJScreen.percentHeight(a.getFloat(R.styleable.jjlayoutplus_cllMarginBottomPercentScreenHeight,0f))
            }

            R.styleable.jjlayoutplus_cllMarginEndPercentScreenWidth -> {
                lsMargins.right = JJScreen.percentWidth(a.getFloat(R.styleable.jjlayoutplus_cllMarginEndPercentScreenWidth,0f))
            }
            R.styleable.jjlayoutplus_cllMarginStartPercentScreenWidth -> {
                lsMargins.left = JJScreen.percentWidth(a.getFloat(R.styleable.jjlayoutplus_cllMarginStartPercentScreenWidth,0f))
            }
            R.styleable.jjlayoutplus_cllMarginTopPercentScreenWidth -> {
                lsMargins.top = JJScreen.percentWidth(a.getFloat(R.styleable.jjlayoutplus_cllMarginTopPercentScreenWidth,0f))
            }
            R.styleable.jjlayoutplus_cllMarginBottomPercentScreenWidth -> {
                lsMargins.bottom = JJScreen.percentWidth(a.getFloat(R.styleable.jjlayoutplus_cllMarginBottomPercentScreenWidth,0f))
            }

            R.styleable.jjlayoutplus_cllMargin -> {
                lsMargins = JJMargin.all(a.getDimension(R.styleable.jjlayoutplus_cllMargin,0f).toInt())
            }
            R.styleable.jjlayoutplus_cllMarginPerScHeight -> {
                lsMargins = JJMargin.all(JJScreen.percentHeight(a.getFloat(R.styleable.jjlayoutplus_cllMarginPerScHeight,0f)))
            }
    ...
    fun setSupportLandScape(support:Boolean) : JJCategoryViewCircle {
        mSupportLandScape = support
        return this
    }

    fun setSupportConfigurationChanged(support:Boolean) : JJCategoryViewCircle {
        mConfigurationChanged = support
        return this
    }

    fun addViews(vararg views: View): JJCategoryViewCircle {
        for (v in views) {
            addView(v)
        }
        return this
    ...
    fun setIdentifier(value: Int): JJCategoryViewCircle {
        mIdentifier = value
        return this
    }
    ...
    fun setState(state: Int): JJCategoryViewCircle {
        mState = state
        return this
    }
    ...
    fun setAttribute(string:String): JJCategoryViewCircle {
        mAttribute = string
        return this
    }
    ...
    fun setPadding(padding: JJPadding): JJCategoryViewCircle {
        mlpPadding = padding
        setPaddingRelative(padding.left,padding.top,padding.right,padding.bottom)
        return this
    }

    fun setOnClickListenerR(listener: (view: View) -> Unit): JJCategoryViewCircle {
        setOnClickListener(listener)
        return this
    }

    fun setOnFocusChangeListenerR(listener: View.OnFocusChangeListener): JJCategoryViewCircle {
        onFocusChangeListener = listener
        return this
    }


    fun setIsFocusable(boolean: Boolean): JJCategoryViewCircle {
        isFocusable = boolean
        return this
    }

    fun setOnTouchListenerR(listener: View.OnTouchListener): JJCategoryViewCircle {
        setOnTouchListener(listener)
        return this
    }

    fun setFitsSystemWindowsR(boolean: Boolean): JJCategoryViewCircle {
        fitsSystemWindows = boolean
        return this
    }

    fun setBackgroundColorR(color: Int): JJCategoryViewCircle {
        setBackgroundColor(color)
        return this
    }

    fun setBackgroundR(drawable: Drawable?): JJCategoryViewCircle {
        background = drawable
        return this
    }

    @RequiresApi(Build.VERSION_CODES.LOLLIPOP)
    fun setOutlineProviderR(provider: ViewOutlineProvider): JJCategoryViewCircle {
        outlineProvider = provider
        return this
    }

    fun setFullScreen(): JJCategoryViewCircle {
        systemUiVisibility = (
    ...
    fun setIsFocusableInTouchMode(boolean: Boolean): JJCategoryViewCircle {
    ...
    fun setVisibilityR(type: Int): JJCategoryViewCircle {
        visibility = type
        return this
    }

    fun setMinHeightR(h:Int): JJCategoryViewCircle {
        minHeight = h
        return this
    }

    fun setMinWidthR(w:Int): JJCategoryViewCircle {
        minWidth = w
        return this
    }

    fun setMinimumHeightR(h:Int): JJCategoryViewCircle {
        minimumHeight = h
        return this
    }

    fun setMinimumWidthR(w:Int): JJCategoryViewCircle {
        minimumWidth = w
        return this
    }
    ...
    @RequiresApi(Build.VERSION_CODES.LOLLIPOP)
    fun setClipToOutlineR(boolean: Boolean) : JJCategoryViewCircle {
        clipToOutline = boolean
        return this
    }
    @RequiresApi(Build.VERSION_CODES.JELLY_BEAN_MR2)
    fun setClipBoundsR(bounds: Rect) : JJCategoryViewCircle {
        clipBounds = bounds
        return this
    }
    ...
    fun setClipChildrenToPath(path: Path): JJCategoryViewCircle {
    ...
    fun setClipAllToPath(path: Path): JJCategoryViewCircle {
        mPathClipAll = path
    ...
    fun setClipOutChildrenToPath(path: Path): JJCategoryViewCircle {
        mPathClipChildren = path
        mIsPathClosureClipChildren = false
    ...
    fun setClipOutAllToPath(path: Path): JJCategoryViewCircle {
        mPathClipAll = path
        mIsPathClosureClipAll = false
    ...
    fun setClipChildrenToPath(closure:(RectF, Path)->Unit): JJCategoryViewCircle {
        mIsClipInPathChildren = true
    ...
    fun setClipAllToPath(closure:(RectF, Path, JJPadding)->Unit): JJCategoryViewCircle {
        mIsClipInPathAll = true
    ...
    fun setClipOutChildrenToPath(closure:(RectF, Path)->Unit): JJCategoryViewCircle {
        mIsClipInPathChildren = false
        mIsPathClosureClipChildren = true
        mIsClipOutPathChildren = true
        mIsClipChildrenEnabled = true
    ...
    fun setClipOutAllToPath(closure:(RectF, Path, JJPadding)->Unit): JJCategoryViewCircle {
        mIsClipInPathAll = false
        mIsPathClosureClipAll = true
        mIsClipOutPathAll = true
        mIsClipAllEnabled = true
    ...
    fun disposeClipPathChildren(): JJCategoryViewCircle {
        mIsClipOutPathChildren = false
        mIsPathClosureClipChildren = false
    ...
    fun disposeClipPathAll(): JJCategoryViewCircle {
        mIsClipOutPathAll = false
        mIsPathClosureClipAll = false
    ...
    fun lpWidth(w: Int) : JJCategoryViewCircle{
        mlpWidth = w
        return this
    }
    fun lpHeight(h: Int) : JJCategoryViewCircle{
        mlpHeight = h
        return this
    }
    fun lpPadding(pad: JJPadding) : JJCategoryViewCircle{
        mlpPadding = pad
        return this
    }

    fun lpMargin(mar: JJMargin) : JJCategoryViewCircle{
        mlpMargins = mar
        return this
    }
    ...
    fun lplWidth(w: Int) : JJCategoryViewCircle{
        mlsWidth = w
        return this
    }
    fun lplHeight(h: Int) : JJCategoryViewCircle{
        mlsHeight = h
        return this
    }
    fun lplPadding(pad: JJPadding) : JJCategoryViewCircle{
        mlsPadding = pad
        return this
    }

    fun lplMargin(mar: JJMargin) : JJCategoryViewCircle{
        mlsMargins = mar
        return this
    }
    ...
    fun colGravity(gravity: Int): JJCategoryViewCircle {
        setupCol()
    ...
    fun ablScrollFlags(flags: Int) : JJCategoryViewCircle {
        setupAblp()
        (layoutParams as? AppBarLayout.LayoutParams)?.scrollFlags = flags
        return this
    }

    fun ablScrollInterpolator(interpolator: Interpolator) : JJCategoryViewCircle {
        setupAblp()
    ...
    fun rlAlignParentTop(value : Boolean = true): JJCategoryViewCircle {
        setupRlp()
        val data = if(value) 1 else 0
    ...
    fun rlAlignParentStart(value : Boolean = true): JJCategoryViewCircle {
        setupRlp()
        val data = if(value) 1 else 0
    ...
    fun rlAlignParentEnd(value : Boolean = true): JJCategoryViewCircle {
        setupRlp()
        val data = if(value) 1 else 0
    ...
    fun rlAlignParentLeft(value : Boolean = true): JJCategoryViewCircle {
        setupRlp()
        val data = if(value) 1 else 0
    ...
    fun rlAlignParentRight(value : Boolean = true): JJCategoryViewCircle {
        setupRlp()
        val data = if(value) 1 else 0
    ...
    fun rlCenterInParentVertically(value:Boolean = true): JJCategoryViewCircle {
        setupRlp()
        val data = if(value) 1 else 0
    ...
    fun rlCenterInParentHorizontally(value:Boolean = true): JJCategoryViewCircle {
        setupRlp()
        val data = if(value) 1 else 0
    ...
    fun rlAlignBaseline(viewId: Int): JJCategoryViewCircle {
        setupRlp()
    ...
    fun llWeight(w: Float): JJCategoryViewCircle {
        setupLlp()
        (layoutParams as? LinearLayout.LayoutParams)?.weight = w
        return this
    }
    fun llGravity(gravity: Int): JJCategoryViewCircle {
        setupLlp()
    ...
    fun mlVisibilityMode(visibility: Int): JJCategoryViewCircle {
        mMotionConstraintSet?.setVisibilityMode(id, visibility)
        return this
    }

    fun mlVerticalBias(float: Float): JJCategoryViewCircle {
        mMotionConstraintSet?.setVerticalBias(id,float)
        return this
    }
    fun mlHorizontalBias(float: Float): JJCategoryViewCircle {
        mMotionConstraintSet?.setHorizontalBias(id,float)
        return this
    }

    fun mlCenterHorizontallyOf(viewId: Int, marginStart: Int = 0, marginEnd: Int = 0): JJCategoryViewCircle {
    ...
    fun mlCenterVerticallyOf(viewId: Int,marginTop: Int = 0, marginBottom: Int = 0): JJCategoryViewCircle {
    ...
    fun mlMargins(margins: JJMargin) : JJCategoryViewCircle {
    ...
    fun mlFloatCustomAttribute(attrName: String, value: Float): JJCategoryViewCircle {
        mMotionConstraintSet?.setFloatValue(id,attrName,value)
        return this
    }

    fun mlIntCustomAttribute(attrName: String, value: Int): JJCategoryViewCircle {
        mMotionConstraintSet?.setIntValue(id,attrName,value)
        return this
    }

    fun mlColorCustomAttribute(attrName: String, value: Int): JJCategoryViewCircle {
        mMotionConstraintSet?.setColorValue(id,attrName,value)
        return this
    }

    fun mlStringCustomAttribute(attrName: String, value: String): JJCategoryViewCircle {
        mMotionConstraintSet?.setStringValue(id,attrName,value)
        return this
    }

    fun mlRotation(float: Float): JJCategoryViewCircle {
        mMotionConstraintSet?.setRotation(id,float)
        return this
    }

    fun mlRotationX(float: Float): JJCategoryViewCircle {
        mMotionConstraintSet?.setRotationX(id,float)
        return this
    }

    fun mlRotationY(float: Float): JJCategoryViewCircle {
        mMotionConstraintSet?.setRotationY(id,float)
        return this
    }

    fun mlTranslation(x: Float,y: Float): JJCategoryViewCircle {
        mMotionConstraintSet?.setTranslation(id,x,y)
        return this
    }
    fun mlTranslationX(x: Float): JJCategoryViewCircle {
        mMotionConstraintSet?.setTranslationX(id,x)
        return this
    }

    fun mlTranslationY(y: Float): JJCategoryViewCircle {
        mMotionConstraintSet?.setTranslationY(id,y)
        return this
    }

    fun mlTranslationZ(z: Float): JJCategoryViewCircle {
        mMotionConstraintSet?.setTranslationZ(id,z)
        return this
    }

    fun mlTransformPivot(x: Float, y: Float): JJCategoryViewCircle {
        mMotionConstraintSet?.setTransformPivot(id,x,y)
        return this
    }

    fun mlTransformPivotX(x: Float): JJCategoryViewCircle {
        mMotionConstraintSet?.setTransformPivotX(id,x)
        return this
    }

    fun mlTransformPivotY(y: Float): JJCategoryViewCircle {
        mMotionConstraintSet?.setTransformPivotY(id,y)
        return this
    }

    fun mlScaleX(x: Float): JJCategoryViewCircle {
        mMotionConstraintSet?.setScaleX(id,x)
        return this
    }

    fun mlScaleY(y: Float): JJCategoryViewCircle {
        mMotionConstraintSet?.setScaleY(id,y)
        return this
    }

    fun mlDimensionRatio(ratio: String): JJCategoryViewCircle {
        mMotionConstraintSet?.setDimensionRatio(id,ratio)
        return this
    }

    fun mlAlpha(alpha: Float): JJCategoryViewCircle {
    ...
    fun mlCenterInParent(verticalBias: Float, horizontalBias: Float, margin: JJMargin): JJCategoryViewCircle {
    ...
    fun mlCenterInParentVertically(): JJCategoryViewCircle {
        mMotionConstraintSet?.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, 0)
        mMotionConstraintSet?.connect(id, ConstraintSet.BOTTOM, ConstraintSet.PARENT_ID, ConstraintSet.BOTTOM, 0)
        mMotionConstraintSet?.setVerticalBias(id, 0.5f)
    ...
    fun mlCenterInParentHorizontally(): JJCategoryViewCircle {
        mMotionConstraintSet?.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, 0)
        mMotionConstraintSet?.connect(id, ConstraintSet.END, ConstraintSet.PARENT_ID, ConstraintSet.END, 0)
        mMotionConstraintSet?.setHorizontalBias(id, 0.5f)
        return this
    ...
    fun mlCenterInParentVertically(bias: Float, topMargin: Int, bottomMargin: Int): JJCategoryViewCircle {
    ...
    fun mlCenterInParentHorizontally(bias: Float, startMargin: Int, endtMargin: Int): JJCategoryViewCircle {
    ...
    fun mlCenterInParentTopVertically(): JJCategoryViewCircle {
        mMotionConstraintSet?.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, 0)
    ...
    fun mlCenterInParentBottomVertically(): JJCategoryViewCircle {
    ...
    fun mlCenterInParentStartHorizontally(): JJCategoryViewCircle {
        mMotionConstraintSet?.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, 0)
    ...
    fun mlCenterInParentEndHorizontally(): JJCategoryViewCircle {
    ...
    fun mlCenterInTopVerticallyOf(viewId: Int): JJCategoryViewCircle {
    ...
    fun mlCenterInBottomVerticallyOf(viewId: Int): JJCategoryViewCircle {
    ...
    fun mlCenterInStartHorizontallyOf(viewId: Int): JJCategoryViewCircle {
    ...
    fun mlCenterInEndHorizontallyOf(viewId: Int): JJCategoryViewCircle {
    ...
    fun mlCenterVertically(topId: Int, topSide: Int, topMargin: Int, bottomId: Int, bottomSide: Int, bottomMargin: Int, bias: Float): JJCategoryViewCircle {
        mMotionConstraintSet?.centerVertically(id, topId, topSide, topMargin, bottomId, bottomSide, bottomMargin, bias)
        return this
    }

    fun mlCenterHorizontally(startId: Int, startSide: Int, startMargin: Int, endId: Int, endSide: Int, endMargin: Int, bias: Float): JJCategoryViewCircle {
        mMotionConstraintSet?.centerHorizontally(id, startId, startSide, startMargin, endId, endSide, endMargin, bias)
        return this
    }


    fun mlFillParent(): JJCategoryViewCircle {
    ...
    fun mlFillParent(margin: JJMargin): JJCategoryViewCircle {
        mMotionConstraintSet?.constrainWidth(id,0)
        mMotionConstraintSet?.constrainHeight(id,0)
        mMotionConstraintSet?.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, margin.top)
        mMotionConstraintSet?.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, margin.left)
    ...
    fun mlFillParentHorizontally(): JJCategoryViewCircle {
        mMotionConstraintSet?.constrainWidth(id,0)
        mMotionConstraintSet?.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, 0)
        mMotionConstraintSet?.connect(id, ConstraintSet.END, ConstraintSet.PARENT_ID, ConstraintSet.END, 0)
        return this
    ...
    fun mlFillParentVertically(): JJCategoryViewCircle {
        mMotionConstraintSet?.constrainHeight(id,0)
        mMotionConstraintSet?.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, 0)
        mMotionConstraintSet?.connect(id, ConstraintSet.BOTTOM, ConstraintSet.PARENT_ID, ConstraintSet.BOTTOM, 0)
        return this
    ...
    fun mlFillParentHorizontally(startMargin: Int, endMargin: Int): JJCategoryViewCircle {
        mMotionConstraintSet?.constrainWidth(id,0)
        mMotionConstraintSet?.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, startMargin)
    ...
    fun mlFillParentVertically(topMargin: Int, bottomMargin: Int): JJCategoryViewCircle {
        mMotionConstraintSet?.constrainHeight(id,0)
        mMotionConstraintSet?.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, topMargin)
        mMotionConstraintSet?.connect(id, ConstraintSet.BOTTOM, ConstraintSet.PARENT_ID, ConstraintSet.BOTTOM, bottomMargin)
        return this
    ...
    fun mlVisibility(visibility: Int): JJCategoryViewCircle {
        mMotionConstraintSet?.setVisibility(id, visibility)
        return this
    }

    fun mlElevation(elevation: Float): JJCategoryViewCircle {
        mMotionConstraintSet?.setElevation(id, elevation)
        return this
    }

    fun mlApply(): JJCategoryViewCircle {
        mMotionConstraintSet?.applyTo(parent as ConstraintLayout)
        return this
    }

    fun mlSetConstraint(cs : ConstraintSet?): JJCategoryViewCircle {
        mMotionConstraintSet = cs
        return this
    }

    fun mlDisposeConstraint(): JJCategoryViewCircle {
    ...
    fun clFloatCustomAttribute(attrName: String, value: Float): JJCategoryViewCircle {
        mConstraintSet.setFloatValue(id,attrName,value)
        return this
    }

    fun clIntCustomAttribute(attrName: String, value: Int): JJCategoryViewCircle {
        mConstraintSet.setIntValue(id,attrName,value)
        return this
    }

    fun clColorCustomAttribute(attrName: String, value: Int): JJCategoryViewCircle {
        mConstraintSet.setColorValue(id,attrName,value)
        return this
    }

    fun clStringCustomAttribute(attrName: String, value: String): JJCategoryViewCircle {
        mConstraintSet.setStringValue(id,attrName,value)
        return this
    }

    fun clRotation(float: Float): JJCategoryViewCircle {
        mConstraintSet.setRotation(id,float)
        return this
    }

    fun clRotationX(float: Float): JJCategoryViewCircle {
        mConstraintSet.setRotationX(id,float)
        return this
    }

    fun clRotationY(float: Float): JJCategoryViewCircle {
        mConstraintSet.setRotationY(id,float)
        return this
    }

    fun clTranslation(x: Float,y: Float): JJCategoryViewCircle {
        mConstraintSet.setTranslation(id,x,y)
        return this
    }
    fun clTranslationX(x: Float): JJCategoryViewCircle {
        mConstraintSet.setTranslationX(id,x)
        return this
    }

    fun clTranslationY(y: Float): JJCategoryViewCircle {
        mConstraintSet.setTranslationY(id,y)
        return this
    }

    fun clTranslationZ(z: Float): JJCategoryViewCircle {
        mConstraintSet.setTranslationZ(id,z)
        return this
    }

    fun clTransformPivot(x: Float, y: Float): JJCategoryViewCircle {
        mConstraintSet.setTransformPivot(id,x,y)
        return this
    }

    fun clTransformPivotX(x: Float): JJCategoryViewCircle {
        mConstraintSet.setTransformPivotX(id,x)
        return this
    }

    fun clTransformPivotY(y: Float): JJCategoryViewCircle {
        mConstraintSet.setTransformPivotY(id,y)
        return this
    }

    fun clScaleX(x: Float): JJCategoryViewCircle {
        mConstraintSet.setScaleX(id,x)
        return this
    }

    fun clScaleY(y: Float): JJCategoryViewCircle {
        mConstraintSet.setScaleY(id,y)
        return this
    }

    fun clDimensionRatio(ratio: String): JJCategoryViewCircle {
        mConstraintSet.setDimensionRatio(id,ratio)
        return this
    }

    fun clAlpha(alpha: Float): JJCategoryViewCircle {
        mConstraintSet.setAlpha(id,alpha)
        return this
    }


    fun clApply(): JJCategoryViewCircle {
        mConstraintSet.applyTo(parent as ConstraintLayout)
        return this
    }

    fun clVisibilityMode(visibility: Int): JJCategoryViewCircle {
        mConstraintSet.setVisibilityMode(id, visibility)
        return this
    }

    fun clVerticalBias(float: Float): JJCategoryViewCircle {
        mConstraintSet.setVerticalBias(id,float)
        return this
    }
    fun clHorizontalBias(float: Float): JJCategoryViewCircle {
        mConstraintSet.setHorizontalBias(id,float)
        return this
    }

    fun clCenterHorizontallyOf(viewId: Int, marginStart: Int = 0, marginEnd: Int = 0): JJCategoryViewCircle {
    ...
    fun clCenterVerticallyOf(viewId: Int,marginTop: Int = 0, marginBottom: Int = 0): JJCategoryViewCircle {
    ...
    fun clMargins(margins: JJMargin) : JJCategoryViewCircle {
    ...
    fun clCenterInParent(verticalBias: Float, horizontalBias: Float, margin: JJMargin): JJCategoryViewCircle {
    ...
    fun clCenterInParentVertically(): JJCategoryViewCircle {
        mConstraintSet.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, 0)
        mConstraintSet.connect(id, ConstraintSet.BOTTOM, ConstraintSet.PARENT_ID, ConstraintSet.BOTTOM, 0)
        mConstraintSet.setVerticalBias(id, 0.5f)
        return this
    ...
    fun clCenterInParentHorizontally(): JJCategoryViewCircle {
        mConstraintSet.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, 0)
        mConstraintSet.connect(id, ConstraintSet.END, ConstraintSet.PARENT_ID, ConstraintSet.END, 0)
        mConstraintSet.setHorizontalBias(id, 0.5f)
        return this
    ...
    fun clCenterInParentVertically(bias: Float, topMargin: Int, bottomMargin: Int): JJCategoryViewCircle {
    ...
    fun clCenterInParentHorizontally(bias: Float, startMargin: Int, endtMargin: Int): JJCategoryViewCircle {
    ...
    fun clCenterInParentTopVertically(): JJCategoryViewCircle {
        mConstraintSet.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, 0)
    ...
    fun clCenterInParentBottomVertically(): JJCategoryViewCircle {
    ...
    fun clCenterInParentStartHorizontally(): JJCategoryViewCircle {
        mConstraintSet.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, 0)
    ...
    fun clCenterInParentEndHorizontally(): JJCategoryViewCircle {
    ...
    fun clCenterInTopVertically(topId: Int): JJCategoryViewCircle {
    ...
    fun clCenterInBottomVertically(bottomId: Int): JJCategoryViewCircle {
    ...
    fun clCenterInStartHorizontally(startId: Int): JJCategoryViewCircle {
    ...
    fun clCenterInEndHorizontally(endId: Int): JJCategoryViewCircle {
    ...
    fun clCenterVertically(topId: Int, topSide: Int, topMargin: Int, bottomId: Int, bottomSide: Int, bottomMargin: Int, bias: Float): JJCategoryViewCircle {
        mConstraintSet.centerVertically(id, topId, topSide, topMargin, bottomId, bottomSide, bottomMargin, bias)
        return this
    }

    fun clCenterHorizontally(startId: Int, startSide: Int, startMargin: Int, endId: Int, endSide: Int, endMargin: Int, bias: Float): JJCategoryViewCircle {
        mConstraintSet.centerHorizontally(id, startId, startSide, startMargin, endId, endSide, endMargin, bias)
        return this
    }


    fun clFillParent(): JJCategoryViewCircle {
        mConstraintSet.constrainWidth(id,0)
        mConstraintSet.constrainHeight(id,0)
        mConstraintSet.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, 0)
        mConstraintSet.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, 0)
    ...
    fun clFillParent(margin: JJMargin): JJCategoryViewCircle {
        mConstraintSet.constrainWidth(id,0)
        mConstraintSet.constrainHeight(id,0)
        mConstraintSet.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, margin.top)
        mConstraintSet.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, margin.left)
    ...
    fun clFillParentHorizontally(): JJCategoryViewCircle {
        mConstraintSet.constrainWidth(id,0)
        mConstraintSet.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, 0)
        mConstraintSet.connect(id, ConstraintSet.END, ConstraintSet.PARENT_ID, ConstraintSet.END, 0)
        return this
    ...
    fun clFillParentVertically(): JJCategoryViewCircle {
        mConstraintSet.constrainHeight(id,0)
        mConstraintSet.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, 0)
        mConstraintSet.connect(id, ConstraintSet.BOTTOM, ConstraintSet.PARENT_ID, ConstraintSet.BOTTOM, 0)
        return this
    ...
    fun clFillParentHorizontally(startMargin: Int, endMargin: Int): JJCategoryViewCircle {
        mConstraintSet.constrainWidth(id,0)
        mConstraintSet.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, startMargin)
    ...
    fun clFillParentVertically(topMargin: Int, bottomMargin: Int): JJCategoryViewCircle {
        mConstraintSet.constrainHeight(id,0)
        mConstraintSet.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, topMargin)
        mConstraintSet.connect(id, ConstraintSet.BOTTOM, ConstraintSet.PARENT_ID, ConstraintSet.BOTTOM, bottomMargin)
        return this
    ...
    fun clVisibility(visibility: Int): JJCategoryViewCircle {
    ...
    fun clElevation(elevation: Float): JJCategoryViewCircle {
    ...
    fun clMinWidth(w:Int): JJCategoryViewCircle {
        mConstraintSet.constrainMinWidth(id,w)
        return this
    }

    fun clMinHeight(h:Int): JJCategoryViewCircle {
        mConstraintSet.constrainMinHeight(id,h)
        return this
    }

    fun clMaxWidth(w:Int): JJCategoryViewCircle {
        mConstraintSet.constrainMaxWidth(id,w)
        return this
    }

    fun clMaxHeight(h:Int): JJCategoryViewCircle {
    ...
    fun cllApply(): JJCategoryViewCircle {
        mConstraintSetLandScape.applyTo(parent as ConstraintLayout)
        return this
    }


    fun cllFloatCustomAttribute(attrName: String, value: Float): JJCategoryViewCircle {
        mConstraintSet.setFloatValue(id,attrName,value)
        return this
    }

    fun cllIntCustomAttribute(attrName: String, value: Int): JJCategoryViewCircle {
        mConstraintSet.setIntValue(id,attrName,value)
        return this
    }

    fun cllColorCustomAttribute(attrName: String, value: Int): JJCategoryViewCircle {
        mConstraintSet.setColorValue(id,attrName,value)
        return this
    }

    fun cllStringCustomAttribute(attrName: String, value: String): JJCategoryViewCircle {
        mConstraintSet.setStringValue(id,attrName,value)
        return this
    }

    fun cllRotation(float: Float): JJCategoryViewCircle {
        mConstraintSet.setRotation(id,float)
        return this
    }

    fun cllRotationX(float: Float): JJCategoryViewCircle {
        mConstraintSet.setRotationX(id,float)
        return this
    }

    fun cllRotationY(float: Float): JJCategoryViewCircle {
        mConstraintSet.setRotationY(id,float)
        return this
    }

    fun cllTranslation(x: Float,y: Float): JJCategoryViewCircle {
        mConstraintSet.setTranslation(id,x,y)
        return this
    }
    fun cllTranslationX(x: Float): JJCategoryViewCircle {
        mConstraintSet.setTranslationX(id,x)
        return this
    }

    fun cllTranslationY(y: Float): JJCategoryViewCircle {
        mConstraintSet.setTranslationY(id,y)
        return this
    }

    fun cllTranslationZ(z: Float): JJCategoryViewCircle {
        mConstraintSet.setTranslationZ(id,z)
        return this
    }

    fun cllTransformPivot(x: Float, y: Float): JJCategoryViewCircle {
        mConstraintSet.setTransformPivot(id,x,y)
        return this
    }

    fun cllTransformPivotX(x: Float): JJCategoryViewCircle {
        mConstraintSet.setTransformPivotX(id,x)
        return this
    }

    fun cllTransformPivotY(y: Float): JJCategoryViewCircle {
        mConstraintSet.setTransformPivotY(id,y)
        return this
    }

    fun cllScaleX(x: Float): JJCategoryViewCircle {
        mConstraintSet.setScaleX(id,x)
        return this
    }

    fun cllScaleY(y: Float): JJCategoryViewCircle {
        mConstraintSet.setScaleY(id,y)
        return this
    }

    fun cllDimensionRatio(ratio: String): JJCategoryViewCircle {
        mConstraintSet.setDimensionRatio(id,ratio)
        return this
    }

    fun cllAlpha(alpha: Float): JJCategoryViewCircle {
        mConstraintSet.setAlpha(id,alpha)
        return this
    }


    fun cllVisibilityMode(visibility: Int): JJCategoryViewCircle {
        mConstraintSetLandScape.setVisibilityMode(id, visibility)
        return this
    }

    fun cllVerticalBias(float: Float): JJCategoryViewCircle {
        mConstraintSetLandScape.setVerticalBias(id,float)
        return this
    }
    fun cllHorizontalBias(float: Float): JJCategoryViewCircle {
        mConstraintSetLandScape.setHorizontalBias(id,float)
        return this
    }

    fun cllCenterHorizontallyOf(viewId: Int, marginStart: Int = 0, marginEnd: Int = 0): JJCategoryViewCircle {
    ...
    fun cllCenterVerticallyOf(viewId: Int,marginTop: Int = 0, marginBottom: Int = 0): JJCategoryViewCircle {
    ...
    fun cllMargins(margins: JJMargin) : JJCategoryViewCircle {
    ...
    fun cllCenterInParent(verticalBias: Float, horizontalBias: Float, margin: JJMargin): JJCategoryViewCircle {
    ...
    fun cllCenterInParentVertically(): JJCategoryViewCircle {
        mConstraintSetLandScape.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, 0)
        mConstraintSetLandScape.connect(id, ConstraintSet.BOTTOM, ConstraintSet.PARENT_ID, ConstraintSet.BOTTOM, 0)
        mConstraintSetLandScape.setVerticalBias(id, 0.5f)
        return this
    ...
    fun cllCenterInParentHorizontally(): JJCategoryViewCircle {
        mConstraintSetLandScape.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, 0)
        mConstraintSetLandScape.connect(id, ConstraintSet.END, ConstraintSet.PARENT_ID, ConstraintSet.END, 0)
        mConstraintSetLandScape.setHorizontalBias(id, 0.5f)
        return this
    ...
    fun cllCenterInParentVertically(bias: Float, topMargin: Int, bottomMargin: Int): JJCategoryViewCircle {
    ...
    fun cllCenterInParentHorizontally(bias: Float, startMargin: Int, endtMargin: Int): JJCategoryViewCircle {
    ...
    fun cllCenterInParentTopVertically(): JJCategoryViewCircle {
        mConstraintSetLandScape.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, 0)
    ...
    fun cllCenterInParentBottomVertically(): JJCategoryViewCircle {
    ...
    fun cllCenterInParentStartHorizontally(): JJCategoryViewCircle {
        mConstraintSetLandScape.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, 0)
    ...
    fun cllCenterInParentEndHorizontally(): JJCategoryViewCircle {
    ...
    fun cllCenterInTopVertically(topId: Int): JJCategoryViewCircle {
    ...
    fun cllCenterInBottomVertically(bottomId: Int): JJCategoryViewCircle {
    ...
    fun cllCenterInStartHorizontally(startId: Int): JJCategoryViewCircle {
    ...
    fun cllCenterInEndHorizontally(endId: Int): JJCategoryViewCircle {
    ...
    fun cllCenterVertically(topId: Int, topSide: Int, topMargin: Int, bottomId: Int, bottomSide: Int, bottomMargin: Int, bias: Float): JJCategoryViewCircle {
        mConstraintSetLandScape.centerVertically(id, topId, topSide, topMargin, bottomId, bottomSide, bottomMargin, bias)
        return this
    }

    fun cllCenterHorizontally(startId: Int, startSide: Int, startMargin: Int, endId: Int, endSide: Int, endMargin: Int, bias: Float): JJCategoryViewCircle {
        mConstraintSetLandScape.centerHorizontally(id, startId, startSide, startMargin, endId, endSide, endMargin, bias)
        return this
    }


    fun cllFillParent(): JJCategoryViewCircle {
        mConstraintSetLandScape.constrainWidth(id,0)
        mConstraintSetLandScape.constrainHeight(id,0)
        mConstraintSetLandScape.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, 0)
        mConstraintSetLandScape.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, 0)
    ...
    fun cllFillParent(margin: JJMargin): JJCategoryViewCircle {
        mConstraintSetLandScape.constrainWidth(id,0)
        mConstraintSetLandScape.constrainHeight(id,0)
        mConstraintSetLandScape.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, margin.top)
        mConstraintSetLandScape.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, margin.left)
    ...
    fun cllFillParentHorizontally(): JJCategoryViewCircle {
        mConstraintSetLandScape.constrainWidth(id,0)
        mConstraintSetLandScape.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, 0)
        mConstraintSetLandScape.connect(id, ConstraintSet.END, ConstraintSet.PARENT_ID, ConstraintSet.END, 0)
        return this
    ...
    fun cllFillParentVertically(): JJCategoryViewCircle {
        mConstraintSetLandScape.constrainHeight(id,0)
        mConstraintSetLandScape.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, 0)
        mConstraintSetLandScape.connect(id, ConstraintSet.BOTTOM, ConstraintSet.PARENT_ID, ConstraintSet.BOTTOM, 0)
        return this
    ...
    fun cllFillParentHorizontally(startMargin: Int, endMargin: Int): JJCategoryViewCircle {
        mConstraintSetLandScape.constrainWidth(id,0)
        mConstraintSetLandScape.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, startMargin)
    ...
    fun cllFillParentVertically(topMargin: Int, bottomMargin: Int): JJCategoryViewCircle {
        mConstraintSetLandScape.constrainHeight(id,0)
        mConstraintSetLandScape.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, topMargin)
        mConstraintSetLandScape.connect(id, ConstraintSet.BOTTOM, ConstraintSet.PARENT_ID, ConstraintSet.BOTTOM, bottomMargin)
        return this
    ...
    fun cllVisibility(visibility: Int): JJCategoryViewCircle {
    ...
    fun cllElevation(elevation: Float): JJCategoryViewCircle {
    ...
    fun cllMinWidth(w:Int): JJCategoryViewCircle {
        mConstraintSetLandScape.constrainMinWidth(id,w)
        return this
    }

    fun cllMinHeight(h:Int): JJCategoryViewCircle {
        mConstraintSetLandScape.constrainMinHeight(id,h)
        return this
    }

    fun cllMaxWidth(w:Int): JJCategoryViewCircle {
        mConstraintSetLandScape.constrainMaxWidth(id,w)
        return this
    }

    fun cllMaxHeight(h:Int): JJCategoryViewCircle {
